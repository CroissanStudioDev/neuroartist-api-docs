...
Подробнее — [Аутентификация](/get-started/authentication).
...
Ветвите по `error` — стабильный machine-readable. Полный список — [коды ошибок](/reference/errors).
...
- [Шпаргалка по API](/reference/cheatsheet) — все публичные эндпоинты одним списком.
- [`/run`](/reference/api/run) — синхронная генерация.
- [`/queue`](/reference/api/queue) — async, polling, SSE и cancel.
